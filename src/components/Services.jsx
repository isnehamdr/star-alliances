  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-6">
        ...
        <div
          ref={arrowRef}
          className="w-8 h-8 rounded-lg bg-[#f5f7f9] flex items-center justify-center text-[#1946bb] group-hover:bg-[#1946bb] group-hover:text-white transition-colors duration-300"
        >
          <ArrowDiagonal />
        </div>
      </div>
    ...
    >
      <div className="  rounded-3xl  py-6 sm:px-16 px-6">
        ...
        ">
          ...
          <div className="flex flex-col gap-4 sm:gap-2 sm:col-span-2 lg:col-span-1 -mt-4">
            {rightCards.map((c, i) => (
              <ProductCard
                key={c.id}
                icon={c.icon}
